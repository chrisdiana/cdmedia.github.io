...
(function() {
    ...
    function initMenu() {
        var showMenu = document.getElementById( 'showMenu' ),
            ...
            moreInfo = container.querySelector('.moreInfo');

        var triggerMenu = function( ev ) {
            ev.stopPropagation();
            ev.preventDefault();
            docscroll = scrollY();
        ...
        moreInfo.addEventListener( clickevent, function( ev ){
            triggerMenu(ev);
        });
    ...
    var infoBar = document.getElementById('infoBar'),
        closeInfoBar = document.getElementById('closeInfoBar');
    setTimeout( function() {
        infoBar.style.maxHeight = '32px';
    }, 2000 );
    closeInfoBar.addEventListener( clickevent, function( ev ) {
       infoBar.style.maxHeight = '5px';
    });
    ...
    jQuery.featherlight.contentFilters.iframe = {
